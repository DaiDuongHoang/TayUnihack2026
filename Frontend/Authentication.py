...
def _inject_auth_styles() -> None:
    ...
    st.markdown(
        ...
        .auth-hero {{
            ...
            animation: authFadeUp 0.55s ease-out both, authGlowPulse 4.5s ease-in-out infinite;
        }}
        ...
        .st-key-guest_login_button button,
        .st-key-local_login_submit button,
        ...
        .st-key-guest_login_button button:hover,
        .st-key-local_login_submit button:hover,
        .st-key-local_register_submit button:hover {{
            transform: translateY(-2px);
            border-color: #c6c9cc !important;
            box-shadow: 0 10px 24px rgba(60, 64, 67, 0.18) !important;
        }}
...
def login_screen(
    ...
    st.markdown(
        f"""
        <div class="auth-hero">
            <p class="auth-hero-eyebrow">Secure Access</p>
